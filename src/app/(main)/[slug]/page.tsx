...
function CategoryPostsSkeleton({ isFirstPage = true }: { isFirstPage?: boolean }) {
  return (
          ...
          <div className="lg:col-span-1 flex flex-col justify-between gap-4 md:gap-5">
            {[1, 2].map((idx) => (
              <div key={idx} className="space-y-2">
                <div className="w-full h-[140px] bg-gray-200 rounded"></div>
          ...
          <div className="mb-4 md:mb-6">
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                ...
                <h4 className="font-semibold text-sm hover:text-[var(--color-accent-main)] cursor-pointer font-bold">
