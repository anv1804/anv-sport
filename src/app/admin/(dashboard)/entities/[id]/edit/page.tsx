...
export default async function EditEntityPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const biNationality: string[] = Array.isArray(bi?.nationality)
    ? bi.nationality
    : bi?.nationality ? [bi.nationality] : [];
  const biPosition: string[] = Array.isArray(bi?.position)
    ? bi.position
    : bi?.position ? [bi.position] : [];
  ...
  return (
    <div className="w-full animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
      <form action={updateEntityWithId}>
                ...
                <div className="flex items-center gap-2 mb-1">
                  {entity.avatar ? (
                    <img
                      src={entity.avatar}
                      alt={entity.name}
                      className="w-8 h-8 rounded-lg object-cover border-2 border-white/40"
                    />
                  ) : (
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 items-start">
          ...
          <div className="xl:col-span-8 space-y-5">
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                  ...
                  <Input
                    id="basicInfo_birthDate"
                    type="date"
                    name="basicInfo_birthDate"
                    defaultValue={bi?.birthDate || ''}
                  />
                </div>
              </div>
            </FormSection>
            ...
            >
              <div className="space-y-5">
                <div>
                  ...
                  <MultiNationalityPicker
                    name="basicInfo_nationality"
                    defaultValues={biNationality}
                  />
                </div>
                ...
                <div>
                  ...
                  <MultiPositionSelect
                    name="basicInfo_position"
                    defaultValues={biPosition}
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 pt-1 border-t border-slate-100">
                  <div>
                    ...
                    <Input
                      id="basicInfo_height"
                      type="number"
                      name="basicInfo_height"
                      defaultValue={bi?.height || ''}
                      placeholder="VD: 178"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      id="basicInfo_shirtNumber"
                      type="number"
                      name="basicInfo_shirtNumber"
                      defaultValue={bi?.shirtNumber || ''}
                      placeholder="VD: 7"
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <Input
                      id="basicInfo_playerValue"
                      name="basicInfo_playerValue"
                      defaultValue={bi?.playerValue || ''}
                      placeholder="VD: 147M"
                    />
                  </div>
                  <div className="md:col-span-2">
                    ...
                    <Input
                      id="basicInfo_contractUntil"
                      type="date"
                      name="basicInfo_contractUntil"
                      defaultValue={bi?.contractUntil || ''}
                    />
                  </div>
                </div>
              </div>
            ...
            >
              <StatsEditor name="stats" defaultValue={statsJson} />
            </FormSection>
            ...
            >
              <AchievementsEditor name="achievements" defaultValue={achievementsJson} />
            </FormSection>
          ...
          <div className="xl:col-span-4 space-y-5 xl:sticky xl:top-6">
            ...
            <div className="bg-gradient-to-br from-emerald-600 to-teal-500 rounded-2xl p-5 shadow-lg shadow-emerald-200">
              ...
              <p className="text-xs text-center text-emerald-100 mt-3 leading-relaxed">
                Đảm bảo mã JSON hợp lệ để<br />tránh lỗi khi render giao diện.
              </p>
            </div>
