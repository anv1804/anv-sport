...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  if (!dbUser && userEmail === 'nguyenan18404@gmail.com') {
      ...
      <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
        <div className="bg-white p-8 rounded-2xl shadow-xl border border-red-100 max-w-md text-center">
          ...
          <p className="text-slate-500 mb-8 font-medium">
            Tài khoản của bạn (<span className="text-slate-800 font-bold">{userEmail}</span>) chưa được phân quyền quản trị. Vui lòng liên hệ Admin để cấp quyền.
          </p>
